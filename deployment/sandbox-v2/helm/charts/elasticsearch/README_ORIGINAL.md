apiVersion: v1
description: MOSIP modified Elastic helm chart for Elasticsearch
...
[mosipuser@console elasticsearch]$ ^C
[mosipuser@console elasticsearch]$
[mosipuser@console elasticsearch]$ ls
Chart.yaml  Makefile  README.md  README_ORIGINAL.md  templates  values.template.j2  values.yaml
[mosipuser@console elasticsearch]$ cat Makefile
include ../helpers/common.mk
[mosipuser@console elasticsearch]$ ^C
[mosipuser@console elasticsearch]$ ls
Chart.yaml  Makefile  README.md  README_ORIGINAL.md  templates  values.template.j2  values.yaml
[mosipuser@console elasticsearch]$ cat README.md
...
[mosipuser@console elasticsearch]$ ls
Chart.yaml  Makefile  README.md  README_ORIGINAL.md  templates  values.template.j2  values.yaml
[mosipuser@console elasticsearch]$ cat README_ORIGINAL.md
